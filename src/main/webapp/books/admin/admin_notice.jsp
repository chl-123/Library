...
<%@ page
        import="com.cya.pojo.Notice,com.cya.pojo.Type,com.cya.dao.AdminDao,com.cya.dao.TypeDao,com.cya.dao.BookDao,com.cya.pojo.Admin" %>
                                        ...
                                        <form class="form-horizontal" action="/manage-books-ofSystem/selectServlet"
                                            ...
                                            <div class="col-lg-3 form-group">
                                                ...
                                                <button type="button" class="btn btn-primary" id="btn_add"
                                                        data-toggle="modal"
                                                        data-target="#addNoticeModal">添加公告
                                                </button>
                                            </div>
                                        </form>
                                    </div>
